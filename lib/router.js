...
// loog 
router.get('/loog_zyc/kjt', require('./routes/loogxyz/zyc/kjt'));
router.get('/loog_zyc/gggs', require('./routes/loogxyz/zyc/gggs'));
router.get('/loog_zyc/wjtz', require('./routes/loogxyz/zyc/wjtz'));
router.get('/loog_zyc/kjt_zcwj', require('./routes/loogxyz/zyc/kjt_zcwj'));
router.get('/loog_zyc/zzskjj', require('./routes/loogxyz/zyc/zzskjj'));
router.get('/loog_zyc/kjjh_tztg', require('./routes/loogxyz/zyc/kjjh_tztg'));
